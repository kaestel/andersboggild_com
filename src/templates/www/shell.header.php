...
<head>
	...
	<meta name="description" content="Foto portfolio for Anders Bøggild" />
	<meta name="verify-v1" content="qwbdnInV1IpH3uOu9m11MAM6GGy5JQjlkWNXS6Ek0H0=" />
	...
	<div id="nav">
		<ul class="i:menu menu">
			...
			<li class="contact">
				...
				<span>ANDERS B&Oslash;GILD</span>
				<span>N&Oslash;RREBROGADE 7A</span>
				<span>2200 COPENHAGEN N</span>

				<span class="tel"><span class="value">+45 4094 2202</span></span>
				<span class="otliam"><script type="text/javascript">u.otliam('MAIL', 'ANDERSBOGGILD.COM');</script></span>
			</li>
				...
				function createMenu($items){
					...
					if($items["id"]) {
						foreach($items["id"] as $key => $value) {
							...
							$selected = $value == Session::getValue("nav") ? "selected" : false;
